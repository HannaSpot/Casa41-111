...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Living in Bucaramanga | Live Bucaramanga", description: "A local guide to Bucaramanga and Altos de Cabecera.", url: "/en/living-in-bucaramanga", siteName: "Live Bucaramanga", locale: "en_US", type: "website", images: [{ url: "/casa/compartir-fachada.jpg", alt: "Family house in Altos de Cabecera, Bucaramanga" }] },
  twitter: { card: "summary_large_image", title: "Living in Bucaramanga | Live Bucaramanga", description: "Guides to Cabecera, daily life and buying property in Bucaramanga.", images: ["/casa/compartir-fachada.jpg"] }
};
