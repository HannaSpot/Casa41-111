const faqContent = {
  es: {
    ...
    items: [
      ...
      ["¿Cuántas habitaciones y baños tiene?", "Tiene siete habitaciones y cinco baños en total, incluida una habitación de servicio con baño independiente."],
  ...
  en: {
    ...
    items: [
      ...
      ["How many bedrooms and bathrooms are there?", "The property has seven bedrooms and five bathrooms in total, including a separate service bedroom and bathroom."],
